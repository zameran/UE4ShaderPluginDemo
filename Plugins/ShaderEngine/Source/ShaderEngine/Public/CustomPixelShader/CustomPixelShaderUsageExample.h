...
#include "Private/CustomPixelShader/CustomPixelShaderDeclaration.h"
 ...
 */
class SHADERENGINE_API FCustomPixelShaderUsageExample
{
public:
	FCustomPixelShaderUsageExample(FColor StartColor, ERHIFeatureLevel::Type ShaderFeatureLevel);
	~FCustomPixelShaderUsageExample();
